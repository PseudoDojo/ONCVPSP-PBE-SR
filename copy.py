...
#  os.system('mv '+str(elements[ii])+'.psml  '+str(elements[ii])+'/'+str(elements[ii])+'_str.psml')
   os.system('cd '+str(elements[ii])+'/ && wget http://www.pseudo-dojo.org/pseudos/nc-si-04_pbe_standard/'+str(elements[ii])+'.html && mv '+str(elements[ii])+'.html '+str(elements[ii])+'_std.html && cd ../' )
   os.system('cd '+str(elements[ii])+'/ && wget http://www.pseudo-dojo.org/pseudos/nc-sr-04_pbe_stringent/'+str(elements[ii])+'.html && mv '+str(elements[ii])+'.html '+str(elements[ii])+'_str.html && cd ../' )
